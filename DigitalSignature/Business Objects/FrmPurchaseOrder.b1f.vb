...
Namespace DigitalSignature
    <FormAttribute("142_", "Business Objects/FrmPurchaseOrder.b1f")>
    Friend Class FrmPurchaseOrder
        ...
        Private Sub Button0_ClickAfter(sboObject As System.Object, pVal As SAPbouiCOM.SBOItemEventArg) Handles Button0.ClickAfter
            Try
                ...
                TranName = objform.DataSources.DBDataSources.Item(0).TableName ' "PO"
                ...
                If GetEnabledRpttoPDF = "Y" Then
                    ...
                    End If
                Else
                    objaddon.objDSC.Create_Digital_Signature_Without_RPT(EditText1.Value, TranName)
                End If
